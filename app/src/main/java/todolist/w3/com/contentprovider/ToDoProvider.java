...
public class ToDoProvider extends ContentProvider {
    ...
    public static final String AUTHORITY="todolist.w3.com.contentprovider";
    ...
    public static final String MIME_TYPE_1 = ContentResolver.CURSOR_DIR_BASE_TYPE+"/"+ "vnd.com.contentprovider.todos";
    public static final String MIME_TYPE_2 = ContentResolver.CURSOR_DIR_BASE_TYPE+"/"+ "vnd.com.contentprovider.todos.place";
    public static final String MIME_TYPE_3 = ContentResolver.CURSOR_ITEM_BASE_TYPE+"/"+ "vnd.com.contentprovider.todocount";
